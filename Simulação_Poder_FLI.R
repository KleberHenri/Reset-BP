...
write.table(result100, file = "MuEta2testTam50_C1.txt", sep = " ")

qestimado100=rbind(quantilRV,quantilE,quantilW,quantilG) # quantilRV,quantilE,quantilW
write.table(qestimado100, file = "qestimMuEta2test50_C1.txt", sep = " ")
...
write.table(resultPoder50, file = "MuEta2testPoderFLI50_C1.txt", sep = " ")
